        ...
        columns={[
          ...
          <div className={styles.sectionText}>
            ...
            <p>
              ...
              with intellectual and developmental exceptionalities to perform
              tasks from pastry production, customer service, dishwashing,
              machine maintenance, and inventory management. Our kitchen
              utilizes volunteer job coaches to assist in vocational training
              for our employees. We make handmade pastries using quality
              ingredients, sourcing local, seasonal ingredients as much as
              possible. Baked with love, always.
            </p>
          </div>,
        ]}
      />
      ...
      <Section
        columns={[
          <p className={styles.sectionText}>
            ...
            within the New Orleans school system, Twyla decided to advocate for
          ...
          <p className={styles.sectionText}>
            ...
            advocate for her students. Locally, Twyla has worked as a pastry
            chef at Satsuma Café and a continued her training under Chef Beth
            Biundo at Beth Biundo Sweets. Twyla envisioned L’Oven Bakeshop as a
            platform for people with exceptionalities to advocate for their
